...
public class FieldOfVision : MonoBehaviour
{
    ...
    public LayerMask hiding_spotMask;
    public LayerMask doorsMask;
    public List<Transform> visibleTargets=new List<Transform>();
    public List<Transform> visibleGoal=new List<Transform>();
    public List<Transform> visibleHidingSpot = new List<Transform>();
    ...
    void FindVisibleGoal()
    {
        visibleGoal.Clear();
        Collider[] goalInViewRadius = Physics.OverlapSphere(transform.position, viewRadius, goalMask);
